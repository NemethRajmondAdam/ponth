...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 29. 12:18
...
--
-- Tábla szerkezet ehhez a táblához `boxesdetails`
--

CREATE TABLE `boxesdetails` (
  `id` int(11) NOT NULL,
...
--
-- Tábla szerkezet ehhez a táblához `costume_cocktail`
--

CREATE TABLE `costume_cocktail` (
  `id` int(11) NOT NULL,
...
--
-- Tábla szerkezet ehhez a táblához `costume_cocktail_ingredients`
--

CREATE TABLE `costume_cocktail_ingredients` (
  `id` int(11) NOT NULL,
  `costume_cocktail_id` int(11) NOT NULL,
  `ingredient_id` int(11) NOT NULL,
  `quantity` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tábla szerkezet ehhez a táblához `cotsume_cocktail_drinks`
--

CREATE TABLE `cotsume_cocktail_drinks` (
  `id` int(11) NOT NULL,
  `costume_cocktail_id` int(11) NOT NULL,
  `drink_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `orders` (
  `id` int(11) NOT NULL,
  `boxes_details_id` int(11) DEFAULT NULL,
...
--
-- Tábla szerkezet ehhez a táblához `ordesrs_extra`
--

CREATE TABLE `ordesrs_extra` (
  `id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `type` enum('Drink','Ingredient','','') NOT NULL,
  `boxes_details_id` int(11) NOT NULL,
  `quantity` int(11) NOT NULL,
  `price` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- A tábla indexei `boxesdetails`
--
ALTER TABLE `boxesdetails`
  ADD PRIMARY KEY (`id`),
...
--
-- A tábla indexei `costume_cocktail`
--
ALTER TABLE `costume_cocktail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `cocktail_id` (`cocktail_id`);

--
-- A tábla indexei `costume_cocktail_ingredients`
--
ALTER TABLE `costume_cocktail_ingredients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `costume_cocktail_id` (`costume_cocktail_id`),
  ADD KEY `ingredient_id` (`ingredient_id`);

--
-- A tábla indexei `cotsume_cocktail_drinks`
--
ALTER TABLE `cotsume_cocktail_drinks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `costume_cocktail_id` (`costume_cocktail_id`),
  ADD KEY `drink_id` (`drink_id`);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `boxes_deatils_id` (`boxes_details_id`),
  ADD KEY `item_id` (`item_id`);

--
-- A tábla indexei `ordesrs_extra`
--
ALTER TABLE `ordesrs_extra`
  ADD PRIMARY KEY (`id`),
  ADD KEY `item_id` (`item_id`),
  ADD KEY `box_id` (`boxes_details_id`),
...
--
-- AUTO_INCREMENT a táblához `boxesdetails`
--
ALTER TABLE `boxesdetails`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT a táblához `costume_cocktail`
--
ALTER TABLE `costume_cocktail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT a táblához `costume_cocktail_ingredients`
--
ALTER TABLE `costume_cocktail_ingredients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT a táblához `cotsume_cocktail_drinks`
--
ALTER TABLE `cotsume_cocktail_drinks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT a táblához `ordesrs_extra`
--
ALTER TABLE `ordesrs_extra`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Megkötések a táblához `boxesdetails`
--
ALTER TABLE `boxesdetails`
  ADD CONSTRAINT `boxesdetails_ibfk_1` FOREIGN KEY (`box_id`) REFERENCES `boxes` (`id`);
...
--
-- Megkötések a táblához `costume_cocktail`
--
ALTER TABLE `costume_cocktail`
  ADD CONSTRAINT `costume_cocktail_ibfk_1` FOREIGN KEY (`cocktail_id`) REFERENCES `cocktails` (`id`),
  ADD CONSTRAINT `costume_cocktail_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Megkötések a táblához `costume_cocktail_ingredients`
--
ALTER TABLE `costume_cocktail_ingredients`
  ADD CONSTRAINT `costume_cocktail_ingredients_ibfk_1` FOREIGN KEY (`costume_cocktail_id`) REFERENCES `costume_cocktail` (`id`),
  ADD CONSTRAINT `costume_cocktail_ingredients_ibfk_2` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredients` (`id`);

--
-- Megkötések a táblához `cotsume_cocktail_drinks`
--
ALTER TABLE `cotsume_cocktail_drinks`
  ADD CONSTRAINT `cotsume_cocktail_drinks_ibfk_1` FOREIGN KEY (`costume_cocktail_id`) REFERENCES `costume_cocktail` (`id`),
  ADD CONSTRAINT `cotsume_cocktail_drinks_ibfk_2` FOREIGN KEY (`drink_id`) REFERENCES `drinks` (`id`);
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`boxes_details_id`) REFERENCES `boxesdetails` (`id`),
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `drinks` (`id`);

--
-- Megkötések a táblához `ordesrs_extra`
--
ALTER TABLE `ordesrs_extra`
  ADD CONSTRAINT `ordesrs_extra_ibfk_1` FOREIGN KEY (`boxes_details_id`) REFERENCES `boxesdetails` (`id`),
  ADD CONSTRAINT `ordesrs_extra_ibfk_3` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`);
